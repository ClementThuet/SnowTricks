...
/* WEBPACK VAR INJECTION */(function($, jQuery) {//Pour ajout/édit d'un média à un trick
...
$(document).ready(function () {
  $(".btn-voir-plus-tricks").click(function () {
    ...
    var allcount = Number($("#all").val());
    var nbTricksBase = 8;
    var nbTricksToAdd = 8; //Si ceux à charger sont la suite de ceux chargé de base
    ...
    if (lastDisplayed <= allcount) {
      ...
      $.ajax({
        ...
        type: "POST",
        data: {
          "firstTrick": lastDisplayed,
          "nbTricksToAdd": nbTricksToAdd
        },
        async: true,
        beforeSend: function beforeSend() {
        ...
        success: function success(response) {
          ...
          var rowno = lastDisplayed + nbTricksBase; // checking row value is greater than allcount or not
...
jQuery(document).ready(function () {
  ...
  $collectionHolder = $('ul.medias'); // add the "add a tag" anchor and li to the tags ul

  $collectionHolder.append($newLinkLi); // add a delete link to all of the existing tag form li elements
...
$(document).ready(function () {
  $(".btn-delete-media-already-saved").click(function () {
    ...
    var $wrapper = $("[data-id=" + $idToDelete + "]"); ////var $wrapperToDelete  = (this).closest(".media-already-saved");
    // var $wrapperToDelete = $('.media-already-saved');

    $wrapper.fadeOut();
    $wrapper.remove(); //var idToDelete = $wrapperToDelete.data("id");
