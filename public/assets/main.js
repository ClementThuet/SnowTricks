...
/* WEBPACK VAR INJECTION */(function($) {//Demandede confirmation pour la suppression d'une figure
...
$(document).ready(function () {
  ...
  $('.btn-comment-voir-plus').click(function () {
    ...
    var nbMessageToAdd = 5; //Si ceux à charger sont la suite de ceux chargé de base

    if (nbCommentsBase === lastDisplayed + nbCommentsBase) {
      lastDisplayed += nbCommentsBase;
    } else {
      //Si ceux à charger sont la suite de commentaires déja chargés
    ...
    if (lastDisplayed <= allcount) {
      ...
      $.ajax({
        ...
        data: {
          "row": lastDisplayed,
          "idFigure": idFigure,
          "firstMessage": lastDisplayed,
          "nbMessageToAdd": nbMessageToAdd
        },
        async: true,
        ...
        success: function success(response) {
          ...
          var rowno = lastDisplayed + nbCommentsBase; // checking row value is greater than allcount or not
      ...
      $('.btn-comment-voir-plus').hide(); // Setting little delay while removing contents
